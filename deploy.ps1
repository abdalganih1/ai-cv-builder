...
if (-not $SkipPush) {
    ...
    # تذكير بمتابعة حالة النشر
    Write-Host ""
    Write-Warning "═══════════════════════════════════════════════════════════════"
    Write-Warning "⚠️  مهم: يجب التحقق من حالة النشر على Cloudflare Pages!"
    Write-Warning "   إذا فشل النشر ← أولوية قصوى لإصلاحه قبل أي شيء آخر"
    Write-Warning "   رابط النشر: cv.abdalgani.com"
    Write-Warning "═══════════════════════════════════════════════════════════════"
    Write-Host ""
}
else {
